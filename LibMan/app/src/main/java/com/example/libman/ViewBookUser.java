...
public class ViewBookUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_bookuser);
        ...
        home.setOnClickListener(v -> {
            ...
            startActivity(new Intent(ViewBookUser.this, UserHome.class));
        });

        Button search = findViewById(R.id.btnsearch);
        search.setOnClickListener(v -> {
            // refresh the activity
            startActivity(new Intent(ViewBookUser.this, ViewBookUser.class));
        });


        Button logout = findViewById(R.id.btnlogout);
        logout.setOnClickListener(v -> {
            startActivity(new Intent(ViewBookUser.this, SelectProfile.class));
        });
    ...
    private static class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                Intent intent = new Intent(context, EditBookUser.class);
