...
public class ViewMember extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(v -> {
            ...
            startActivity(new Intent(ViewMember.this, AdminHome.class));
        });

        Button search = findViewById(R.id.btnsearch);
        search.setOnClickListener(v -> {
            // refresh the activity
            startActivity(new Intent(ViewMember.this, ViewBook.class));
        });


        Button logout = findViewById(R.id.btnlogout);
        logout.setOnClickListener(v -> {
            startActivity(new Intent(ViewMember.this, SelectProfile.class));
        });
